...
<head>
	...
	<title>新建医生</title>
	<meta name="description" content="新建医生">
	<meta name="keywords" content="新建医生">
...
<div class="content"> <!--产品信息-->
	...
	<div class="panel panel-default">
		...
		<div class="row data-type">
			...
			<div class="col-md-2 title">医生的手机号</div>
			<div class="col-md-4 data">
				<input type="text" id = "phone" class="form-control" name="phone"
					   placeholder="医生的手机号" value="">
			</div>

			<div class="col-md-2 title">归属的站点</div>
			<div class="col-md-4 data">
				<input type="text" id = "siteNames" class="form-control" name="siteNames"
					   placeholder="归属的站点" value="">
			</div>

			<div class="col-md-2 title">站点的地址</div>
			<div class="col-md-4 data">
				<input type="text" id = "address" class="form-control" name="address"
					   placeholder="站点的地址" value="">
			</div>
	...
	<div class="box-tools text-center">
		<button type="submit" class="btn bg-maroon" onclick="javascript:addDoctor();">保存</button>
