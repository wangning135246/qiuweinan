...
<head>
    ...
    <title>后台管理系统-站点管理</title>
    <meta name="description" content="后台管理系统-站点管理">
    <meta name="keywords" content="后台管理系统-站点管理">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建站点"
                                            onclick="window.location='http://localhost:8080/siteList/siteAddIndex'">
                                    ...
                                    <button type="button" class="btn btn-default" title="查询"
                                            onclick="javascript:selectSiteList()"><i
                        ...
                        <div class="box-tools pull-right" >
                            <div class="has-feedback">
                                <input type="text" id = "siteName" class="form-control input-sm" placeholder="请输入查询站点的名字" >
                            </div>
                        </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc">站点名称</th>
                                <th class="sorting_asc">分站管理员数</th>
                                <th class="sorting_asc">站点医生数</th>
                                <th class="sorting_asc">站点的状态</th>
