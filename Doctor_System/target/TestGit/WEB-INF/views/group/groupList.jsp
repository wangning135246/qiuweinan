...
<head>
    ...
    <title>后台管理系统-小组管理</title>
    <meta name="description" content="后台管理系统-小组管理">
    <meta name="keywords" content="后台管理系统-小组管理">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="查询"
                                            onclick="javascript:selectGroup()"><i
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_asc">小组名称</th>
                                <th class="sorting_asc">小组人数</th>
