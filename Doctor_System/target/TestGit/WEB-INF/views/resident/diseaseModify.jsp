...
<div class="content"> <!--产品信息-->
	...
	<div class="box-tools text-center">
		<button type="submit" class="btn bg-maroon" onclick="javascript:modifyResident();">保存</button>
