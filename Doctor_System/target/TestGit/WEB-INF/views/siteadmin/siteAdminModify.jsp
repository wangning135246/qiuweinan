			...
			<!-- 内容头部 /-->
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">管理员的名称</div>
						<div class="col-md-4 data">
							<input type="text" id = "adminName" class="form-control" name="siteName"
								   value=${adminName}>
						</div>
						...
						<div class="col-md-2 title">分站管理员电话</div>
						<div class="col-md-4 data">
							<input type="text" id = "phone" class="form-control" name="siteAdmin"
								 value=${phone}>
						</div>

						<div class="col-md-2 title">该站点医生的数量</div>
						<div class="col-md-4 data">
							<input readonly="readonly" type="text" id = "doctorCount" class="form-control" name="doctor"
								 value=${doctorCount}>
						</div>
